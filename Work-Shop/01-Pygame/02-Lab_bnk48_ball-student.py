...
def circles_collide(rect1, rect2):
    r1 = rect1.width / 2
    r2 = rect2.width / 2
...
ball2_img = pg.image.load("source/BNK48/Niky_cc.png").convert_alpha()
...
while running:
    ...
    if running:
        ...
        text_surface = font.render(student_id, True, white)
        ...
        #     ball2_speed[1] = -ball2_speed[1]
        #     pg.mixer.init()
        #     pg.mixer.music.load("source/effect.wav")
        #     pg.mixer.music.play()
        ...
        if circles_collide(ball1_rect, ball2_rect):
            ball1_speed[0] = -ball1_speed[0]
            ball1_speed[1] = -ball1_speed[1]
            ball2_speed[0] = -ball2_speed[0]
            ball2_speed[1] = -ball2_speed[1]
            ...
            pg.mixer.music.load("source/effect.wav")
            pg.mixer.music.play()
        if circles_collide(ball1_rect, ball3_rect):
            ball1_speed[0] = -ball1_speed[0]
            ball1_speed[1] = -ball1_speed[1]
            ball3_speed[0] = -ball3_speed[0]
            ball3_speed[1] = -ball3_speed[1]
            ...
            pg.mixer.music.load("source/effect.wav")
            pg.mixer.music.play()
        if circles_collide(ball2_rect, ball3_rect):
            ball2_speed[0] = -ball2_speed[0]
            ball2_speed[1] = -ball2_speed[1]
            ball3_speed[0] = -ball3_speed[0]
            ball3_speed[1] = -ball3_speed[1]
